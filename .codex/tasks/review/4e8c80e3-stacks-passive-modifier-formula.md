...
- Changed formula from `1.5 ** max(0, stacks - 1)` to `(stacks * 0.05) + 1`
- Implemented in `endless_idler/combat/party_stats.py` line 137-139
- Formula provides linear 5% bonus per stack starting at 1.0 (neutral) with 0 stacks
- Added clear documentation comments explaining the formula

### Acceptance Criteria Met
- [x] Passive modifier formula is implemented correctly
- [x] Formula calculates dynamically based on current stacks
- [x] Returns 1.0 when stacks = 0
- [x] Returns correct values for various stack counts
- [x] Formula is centralized and reusable
