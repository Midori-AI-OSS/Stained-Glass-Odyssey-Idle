...
class PersonaIce(PlayerBase):
    ...
    full_about = (
        ...
        "to shield Lady Fire, his sister, and Lady Fire and Ice, layering protective cold "
    ...
    summarized_about = "A disciplined cryokinetic tank who shields Lady Fire, his sister, and Lady Fire and Ice with protective frost that hardens against blows and heals allies."
    looks = """
