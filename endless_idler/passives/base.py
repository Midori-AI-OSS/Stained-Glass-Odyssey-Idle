"""Legacy combat passive base classes.

These helpers remain in-tree temporarily, but the rebuilt passive framework now
uses `PassivePlugin` discovery instead of this combat-trigger interface.
"""
