...
class ExperienceBoost(Item):
    """Placeholder consumable that advertises an experience boost effect."""

    id: str = "experience_boost"
    name: str = "Experience Boost"
    description: str = "Placeholder consumable that would boost earned experience."
